...
<div className={style.buttons}>  <Link className='btn btn-secondary text-white mt-1 w-25' to={"/Agent_Couerier"}>Back</Link>
</div>
    </div>
      </div>
    </div>
...
export default ViewAgentCouerier
