...
const Agent_AddCouerier = () => {
  ...
  var insertvalues=(e)=>{
    ...
    Parcels.BranchProcessed =JSON.parse(window.localStorage.getItem("userData"))?.bracnh;
          ...
          <option value={"on_hold"}>On Hold</option>
                  ...
                  <div class={style.mb_4}>
                          ...
                          <div class={style.mb_4}>
                            ...
                            <input type="text" value={uagent_branch} className='w-full border rounded p-2' readOnly name='BranchProcessed'  onChange={inputHandle}/>
                          </div>
                          <div class={style.mb_4}>
...
export default Agent_AddCouerier
