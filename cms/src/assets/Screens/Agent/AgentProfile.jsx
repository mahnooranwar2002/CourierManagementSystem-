      ...
      <div className="modal-dialog">
          ...
          <div className={`${style.customHeader} modal-header`}>
              ...
              <div className="form-group">
                          ...
                          <input name='name' readOnly type="text" onChange={handleInput} className="form-control" id="name" required value={agent.name}/>
                      </div>
                      <div>
                      ...
                      <input type="hidden" value={agent.bracnh} name='branch'  onChange={handleInput}/>
                      <div>
