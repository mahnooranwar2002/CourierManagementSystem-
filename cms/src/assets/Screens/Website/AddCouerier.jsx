...
const AddCouerier = () => {
  ...
  var insertvalues = (e) => {
    ...
    Parcels.price =
      Parcels.Weight * Parcels.Height * Parcels.Width * Parcels.Length;
    Parcels.userId = userID;
    Parcels.s_name = userName;
    Parcels.Status = "pending";
    Parcels.delivery_data = "Not Approved !";
  ...
  var fecth_branch_detail = () => {
    axios.get("http://localhost:1234/branch_fetch").then((resp) => {
      branchFetch(resp.data);
    });
  };
  ...
  useEffect(() => {
    fetch_data(), fecth_branch_detail(), company_fetch();
  }, []);
  return (
    <>
      <Navbar></Navbar>
...
<select class="w-full border rounded p-2" name='Status' onChange={inputHandle} value={Parcels.Status}>
    ...
    <option value={"on_hold"}>On Hold</option>
                      ...
                      <div class={style.mb_4}>
                        ...
                        <select
                          class="w-full border rounded p-2"
                          name="BranchProcessed"
                          value={Parcels.BranchProcessed}
                          onChange={inputHandle}
                        >
                          <option hidden>Please select here</option>
                          {brnach_data.map((con) => (
                  ...
                  <div className={style.grid_5}>
                    <button class={style.btn1} type="submit">
                      Save
                    </button>
