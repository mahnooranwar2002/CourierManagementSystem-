...
const EditCoueier = () => {
    ...
    var [Parcels,pracelset]=useState({
      ...
      var insertvalues=(e)=>{
       ...
       alert("The Courier is updated now ");
       axios.put(`http://localhost:1234/pracelEdited/${id}`,Parcels).then((resp)=>{
...
console.log(resp.data);
  ...
  <div className="container-fluid">
        ...
        <h1 className='font-bold'> Edit Courier Details</h1>
        ...
        <div class="mb-13">
                        ...
                        <input type="text" class="w-full border rounded p-2 w-100" placeholder=' enter name' onChange={inputHandle}  name='tracking' value={Parcels.tracking} readOnly/>
                    </div>
